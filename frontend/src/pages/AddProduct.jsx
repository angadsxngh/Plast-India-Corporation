...
function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Reset form
      setFormData({ name: "", quantity: 0, categoryId: "" });
          ...
          <div className="rounded-lg bg-white p-4 shadow-lg sm:p-6 md:p-8">
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    ...
                    <span className="text-sm sm:text-base">Save Product</span>
                  </>
                )}
              </Button>
              <Button
            ...
            <div className="mt-4 rounded-lg bg-blue-50 p-3 sm:mt-6 sm:p-4">
              <p className="text-xs leading-relaxed text-blue-900 sm:text-sm">
                <strong>Note:</strong> Product name and quantity are required. Category is optional but recommended for better organization.
              </p>
            </div>
          </div>
        </form>
